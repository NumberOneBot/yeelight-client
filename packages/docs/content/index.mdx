...
ylc toggle --ip 192.168.0.27         # toggle main + background at once
ylc name "Desk Light" --ip 192.168.0.27
ylc timer set 30 --ip 192.168.0.27   # sleep timer
ylc timer status --ip 192.168.0.27
ylc adjust brightness 20 --ip 192.168.0.27
ylc discover
```
